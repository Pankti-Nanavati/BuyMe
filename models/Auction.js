...
const Auction = {
  getActiveAuctions: async () => {
    try {
      const queryString = 'SELECT p.product_name, a.initial_price, a.end_time FROM bm_auction_system.auction join bm_auction.product p on product_id WHERE end_time > NOW();';
